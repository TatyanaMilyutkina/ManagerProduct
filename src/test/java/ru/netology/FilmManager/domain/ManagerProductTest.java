...
public class ManagerProductTest {
    Book book1 = new Book(1, "Name1", 100, "Author1");
    Book book2 = new Book(2, "Name2", 200, "Author2");
    Book book3 = new Book(3, "Name3", 300, "Author3");
    Smartphone smartphone1 = new Smartphone(4, "Name4", 400, "M1");
    Smartphone smartphone2 = new Smartphone(5, "Name5", 500, "M2");
    Smartphone smartphone3 = new Smartphone(6, "Name6", 600, "M3");
    Smartphone smartphone4 = new Smartphone(7, "Name4", 700, "M4");
